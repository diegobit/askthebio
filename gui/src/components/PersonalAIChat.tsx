      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-start px-6 pt-16 pb-20 transition-all duration-700 ease-out">
        ...
        >
          ...
          >
            ...
            <p className="text-2xl md:text-4xl font-cursive italic text-black/50 dark:text-white/65 font-light">
              of
            </p>
            <h2 className="text-4xl md:text-6xl font-cursive font-medium text-black/70 dark:text-white/85 tracking-wide">
